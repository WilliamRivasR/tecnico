...
-- Volcando datos para la tabla biblioteca_escolar.libros: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla biblioteca_escolar.prestamos: ~11 rows (aproximadamente)
/*!40000 ALTER TABLE `prestamos` DISABLE KEYS */;
REPLACE INTO `prestamos` (`ID_prestamo`, `ID_libro`, `Documento_usuario`, `Fecha_prestamo`) VALUES
	(31, 1, '5962225', '2024-08-07'),
...
-- Volcando datos para la tabla biblioteca_escolar.usuarios: ~5 rows (aproximadamente)
...
REPLACE INTO `usuarios` (`ID_usuario`, `Tipo_usuario`, `Nombre`, `Apellidos`, `Tipo_documento`, `Numero_documento`, `Fecha_nacimiento`, `Correo_electronico`, `Contraseña`, `Telefono`, `LIbros_prestados`) VALUES
	(1, 'estudiante', 'William', 'Rivas', 'PPT', '5962225', '2007-09-26', 'williamjoserrs@gmail.com', '12345', '3195046735', ''),
	(2, 'estudiante', 'Jmes', 'Mosquera', 'CC', '5783321', '1990-01-24', 'jamesmosq@gmail.com', 'JM1234', '76348912', ''),
	(14, 'estudiante', 'willy2', 'rivas', 'PPT', '123456', '2000-09-25', 'willy2rivas@gmail.com', '1234', '32765432', ''),
